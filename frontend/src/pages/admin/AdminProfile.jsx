        ...
        <div className="min-h-screen bg-[#0f0f0f] text-white p-8 pt-24">
            <div className="container mx-auto max-w-3xl">
                <div className="flex justify-between items-center mb-8">
                    <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-neon-orange to-neon-blue">
                        Admin Profile
                    </h1>
                    <button
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        {isEditing && (
                            <button
                                onClick={() => fileInputRef.current.click()}
                                disabled={uploading}
                                className="text-neon-orange hover:text-orange-400 font-medium transition-colors disabled:opacity-50 text-sm"
                            >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-800">
                            <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                                <FaLock className="text-neon-orange" /> Security
                            </h3>
